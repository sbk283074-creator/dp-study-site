...
`std::string` by value copies it — and in Chapter 18 the copy would have been invisible. This struct
...
functions get three different mangled symbols — which is exactly the mechanism Chapter 18 showed you
