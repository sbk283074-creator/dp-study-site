#!/usr/bin/env python3
"""Generate chapters/10-object-equals-hashcode-tostring.md.

    python3 tools/gen/10/gen.py
"""
...
gen = Gen(HERE, CHAPTERS, "10-object-equals-hashcode-tostring.md")

BLOCKS = {
    "defaults": gen.run("DefaultObject.java"),
    "badequals": gen.bad("BadEquals.java",
                         "method does not override or implement a method from a supertype"),
    "overloadequals": gen.run("OverloadEquals.java"),
    "value": gen.run("ValueEquals.java"),
    "nohashcode": gen.warn("NoHashCode.java", "[overrides]"),
    "badhashcode": gen.run("BadHashCode.java"),
    "records": gen.run("RecordKey.java"),
    "mutkey": gen.run("MutableKey.java"),
    "tostring": gen.run("ToString.java"),
    "scenario": gen.run("Scenario.java"),
    "sol1": gen.run("Sol1.java"),
    "sol2": gen.run("Sol2.java"),
    "sol3": gen.run("Sol3.java"),
    "symmetryset": gen.run("SymmetrySet.java"),
