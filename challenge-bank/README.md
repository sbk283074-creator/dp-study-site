...
|---|---|---:|---:|
| Math AA HL | 2021 (runs to Nov 2028) | 79 | 83 / 83 (100%) |
| Physics HL | 2025 | 52 | 24 / 24 (100%) |
| Computer Science HL | 2027 (new Theme A/B) | 27 | 25 / 25 (100%) |
| Business Management SL | 2024 | 20 | 34 / 34 (100%) |
| **Total** | | **178** | **166 / 166 (100%)** |
...
All 178 items are difficulty 4–5 (**96 at difficulty 4, 82 at difficulty 5**), and pass `validate.py`
...
Every item carries a `verification.assertions` list — **1833 machine-checked assertions** in total — so
...
|---|---|---|
| items with evidence for the label | **14 / 178** | 0 / 172 |
...
rules are still breached (Physics HL puts 63% of its items at difficulty 5 against a 50% limit, and no
...
than its 2026-09-13 baseline — and the Physics share has **0.5 percentage points of headroom left**
before it trips that switch, so **the next Physics item may not claim difficulty 5** until the share is
back at or below the 62% baseline.
