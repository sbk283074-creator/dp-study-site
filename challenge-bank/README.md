...
|---|---|---:|---:|
| Math AA HL | 2021 (runs to Nov 2028) | 40 | 62 / 83 (74%) |
...
plus all 8 BM Toolkit nodes. The 21 nodes still open are priority-2 ("should") maths topics, which the
brief orders after every must-cover node.

All 90 items are `published`, difficulty 4–5 (59 at difficulty 4, 31 at difficulty 5), and pass
...
Every item carries a `verification.assertions` list — **961 machine-checked assertions** in total — so
