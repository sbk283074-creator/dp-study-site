...
|---|---|---:|---:|
| Math AA HL | 2021 (runs to Nov 2028) | 97 | 83 / 83 (100%) |
| Physics HL | 2025 | 67 | 24 / 24 (100%) |
| Computer Science HL | 2027 (new Theme A/B) | 34 | 25 / 25 (100%) |
| Business Management SL | 2024 | 26 | 34 / 34 (100%) |
| **Total** | | **224** | **166 / 166 (100%)** |
...
All 224 items are difficulty 4–5 (**132 at difficulty 4, 92 at difficulty 5**), and pass `validate.py`
...
Every item carries a `verification.assertions` list — **2373 machine-checked assertions** in total — so
...
**Sourcing is recorded, not claimed.** 46 items are drawn from other syllabuses — 高考, 强基, 竞赛,
...
|---|---|---|
| items with evidence for the label | **60 / 224** | 0 / 172 |
...
the outset. **Physics HL is now inside the 50% cap and the debt is cleared**; the rule that no new
...
largest single share is 17% of evidenced items, so the bank is no longer one trick in different clothes.
