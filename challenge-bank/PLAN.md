...
**Status: live. 202 questions across the four subjects, every priority-1 and priority-2 syllabus node
covered (166/166 nodes, 100%). The difficulty label is now a measured property rather than a declared
one: from 2026-09-13 every item must carry `difficulty_evidence`, and 38 of 202 do. The remaining 164 are
...
- **Printables — DONE.** `site/papers/` holds a printable question paper and a matching answer booklet
  ...
  87 questions / 1356 marks, physics 59 / 748, CS 32 / 521, BM SL 24 / 355 — all difficulty 4–5, May
  2028 cohort.
