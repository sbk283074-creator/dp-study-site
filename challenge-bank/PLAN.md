...
**Status: live. 80 questions across the four subjects, all published, all gates passing, every
priority-1 syllabus node covered, and 132 of the 166 nodes (79%) covered overall.**
...
- **Batch 6 — DONE.** Ten more items (80 total), the first batch drawn entirely from the priority-2
  ...
  assertions.
- **Batch 6+:** the remaining 34 nodes are all priority-2 ("should") maths topics — Topic 2 (2.6, 2.7,
  2.9, 2.10, 2.11), Topic 3 (3.1–3.8), Topic 4 (statistics and probability) and Topic 5 (calculus) —
  followed by the priority-3 tail.
- **Printables — DONE.** `site/papers/` holds a printable question paper and a matching answer booklet
  ...
  "30 questions · 455 marks · difficulty 4–5 · May 2028 cohort".
