...
**Status: live. 90 questions across the four subjects, all published, all gates passing, every
priority-1 syllabus node covered, and 145 of the 166 nodes (87%) covered overall.**
...
- **Batch 7 — DONE.** Ten more items (90 total), finishing Topic 2 and opening Topic 3. Topic 2 (five
  ...
  assertions.
- **Batch 7+:** the remaining 21 nodes are all priority-2 ("should") maths topics — Topic 4 (statistics
  and probability: 4.1–4.12) and Topic 5 (calculus: 5.1–5.11) — followed by the priority-3 tail.
