/* BPhO Round 0 — key points.
   ...
   Generated by tools/paper2025/build_concepts.py from concepts_a/b/c/d.py. Edit those,
   ...
   index: which of the 37 questions use this point -- the 25 from the 2025 paper plus
   the 12 sample questions.

   71 key points, used 129 times across the two banks.
*/
...
<code>25/6 = 4 + 1/6</code>.</p>`,
    ...
    q: ["R0-02", "R0-05", "R0-14", "R0-16", "R0-19", "R0-22", "R0-23", "R0-25", "R0S-01", "R0S-04", "R0S-05", "R0S-10", "R0S-11", "R0S-12"]
  },
  {
...
multiply, whereas answering with the ratio the wrong way up gives you the reciprocal.</p>`,
    ...
    q: ["R0-09", "R0-22", "R0-25", "R0S-01", "R0S-02", "R0S-04", "R0S-05", "R0S-09", "R0S-10", "R0S-11", "R0S-12"]
  },
  {
...
and assuming a velocity arrow shows position rather than direction of motion.</p>`,
    ...
    q: ["R0-02", "R0-07", "R0S-03", "R0S-07"]
  },
  {
    id: "secondorder", m: "A", stage: 0, t: "When the leading term cancels: energies that scale as the fourth power",
    pre: ["smallchange", "surds"],
    one: "Sometimes a small change produces no first-order effect at all, and the answer is governed by the term you were told to throw away — which is why a sideways nudge of a spring stores so little energy.",
...
horizontal component; and thinking the maximum-height formula is needed here — it is not.</p>`,
  ...
  {
    id: "apparentweight", m: "D", stage: 1, t: "Apparent weight: the normal reaction is not the weight",
    pre: ["circular", "force"],
    one: "The reading of a scale is the normal reaction, not mg. Wherever something is travelling in a circle, the normal reaction is smaller than the weight by exactly the centripetal force required.",
...
<p><b>Where the sample sheet uses it:</b> S11.</p>`,
  ...
  {
    id: "tailmass", m: "C", stage: 1, t: "What a string has to drag: the mass on the far side of the boundary",
    pre: ["force", "ratio"],
    one: "A tension is the force one string applies at one place, so it accelerates only the mass on the far side of that string — not the whole chain, and not the block it is tied to.",
...
does not hold.</p>`,
  ...
  {
    id: "criticalangle", m: "G", stage: 3, t: "The critical angle, and the shape of the curve against refractive index",
    pre: ["snell", "refractive"],
    one: "Going from a medium of index n into air, the critical angle satisfies sin θ꜀ = 1/n — so it starts at 90° just above n = 1, falls steeply, and flattens without ever reaching zero.",
