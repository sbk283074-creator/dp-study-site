...
<p><b>Answer: A.</b></p>
<p><b>The distractors, diagnosed.</b> Option B is the joule, option D is the newton, and option C has the exponent on <code>s</code> wrong by one — the error you make by forgetting that the newton already contains <code>s⁻²</code>.</p>
...
<p><b>Answer: A.</b></p>
<p><b>Why the others fail.</b> Option B, <code>√(m/k)</code>, is <code>√(s²) = s</code> — a time, not a frequency, so it is the reciprocal of what is wanted. Option C, <code>k/m</code>, is <code>s⁻²</code>, which is a frequency squared. Option D, <code>√(km)</code>, is <code>√(kg² s⁻²) = kg s⁻¹</code>, which still carries a mass. Option E, <code>m/k</code>, is <code>s²</code>.</p>
...
},
{
  ...
  opts: ["a = s/t", "v = s/t", "a = v/t", "v² = 2as", "s = ½at²"],
  ans: 0,
...
<tr><td>A: <code>a = s/t</code></td><td><code>m/s = m s⁻¹</code></td><td><code>m s⁻²</code></td><td><b>fails</b></td></tr>
<tr><td>B: <code>v = s/t</code></td><td><code>m s⁻¹</code></td><td><code>m s⁻¹</code></td><td>ok</td></tr>
...
<p><b>Answer: A.</b> <code>s/t</code> is a speed, not an acceleration, so option A cannot be correct.</p>
<p><b>Why the question is easy once you have the habit.</b> Notice that B and C together show the pattern: dividing a speed by a time gives an acceleration, but dividing a distance by a time gives only a speed. One extra division by time is needed, and option A omits it.</p>
...
<p><b>The trap.</b> Option B, 1.01, is the answer you get by ignoring the exponent <code>n</code> entirely — applying the approximation as if <code>n = 1</code>. Option C, 1.20, is what you get from <code>1 + nx</code> with <code>n = 20</code>, or from a slip in reading the exponent.</p>
...
},
{
  ...
  opts: ["0.005 m", "0.050 m", "0.100 m", "0.0005 m", "0.010 m"],
  ans: 0,
...
<p><b>The traps.</b> Option B, 10¹ kg, would be a large dog or a small child. Option C, 10³ kg, is a small car. Option E, 10⁴ kg, is a large truck. Each is a plausible-sounding magnitude for a different object, which is what makes the question discriminate.</p>
...
},
{
  ...
  opts: [
    "A curve rising from the origin with decreasing gradient, approaching a horizontal line",
    "A straight line through the origin",
    "A curve rising from the origin with increasing gradient",
    "A horizontal straight line",
    "A curve falling from a maximum value to zero"
  ],
  ans: 0,
...
<p><b>Answer: A.</b></p>
<p><b>Why the answer must have a decreasing gradient.</b> The only mechanism available is drag, and drag always opposes motion and grows with speed. So the acceleration can only decrease, never increase. That rules out option C on physical grounds alone, without any analysis.</p>
<p><b>The traps.</b> Option B is free fall in a vacuum, which is not what the question describes. Option C would require the acceleration to grow, which drag cannot cause. Option E describes an object thrown upward and returning, not one released from rest.</p>
...
},
{
  ...
  opts: ["3.0 s", "1.5 s", "2.0 s", "4.5 s", "9.0 s"],
  ans: 0,
...
<p><b>The trap.</b> Option D, 4.5 s, is what you get from a slip in the algebra — for example solving <code>t² = 20</code> or forgetting the ½ in a way that leaves <code>t² = 45/10 × ... </code>. Option E, 9.0 s, is <code>t²</code> reported as <code>t</code>, the classic error of failing to take the square root.</p>
...

{
  ...
  opts: ["50 N", "87 N", "100 N", "25 N", "43 N"],
  ans: 0,
...
},
{
  ...
  opts: ["2.0 m s⁻¹", "1.0 m s⁻¹", "3.0 m s⁻¹", "1.5 m s⁻¹", "6.0 m s⁻¹"],
  ans: 0,
...
<p><b>The traps.</b> Option B, 1.0 m s⁻¹, comes from dividing the momentum by the wrong mass. Option D, 1.5 m s⁻¹, is the <i>average</i> of the initial speeds of the two trolleys, which is not a physically meaningful quantity here. Option E, 6.0 m s⁻¹, is the momentum itself reported as a speed.</p>`,
...
},
{
  ...
  opts: ["120 J", "40 J", "80 J", "200 J", "20 J"],
  ans: 0,
...
<p><b>The extension worth doing.</b> If the floor exerted 10 N of friction, the net work would be <code>(30 − 10) × 4.0 = 80 J</code> — option C. That is the kinetic energy gained by the box. The applied force does 120 J, friction removes 40 J, and the difference becomes kinetic energy. Tracking the energy account in that way is what a good answer looks like.</p>
...
},
{
  ...
  opts: ["500 W", "1000 W", "50 W", "5000 W", "200 W"],
  ans: 0,
...
},
{
  ...
  opts: ["3.3 m s⁻²", "5.0 m s⁻²", "6.7 m s⁻²", "10 m s⁻²", "1.7 m s⁻²"],
  ans: 0,
...
<p><b>The traps.</b> Option B, 5.0 m s⁻², comes from using the correct numerator but only the heavier mass in the denominator: <code>20/4.0 = 5.0</code>. Option C, 6.7 m s⁻², is <code>20/3.0</code>. Option D, 10 m s⁻², is free fall, which ignores the lighter mass entirely.</p>
...
<p><b>The traps.</b> Option B, 30°, is the answer you get by recalling <code>tan 30° = 0.577</code> and rounding carelessly, or by assuming the slide angle is always 30°. Option C, 45°, would require <code>μ = 1</code>.</p>
...
},
{
  ...
  opts: ["3.0 m", "1.0 m", "2.0 m", "3.5 m", "4.0 m"],
  ans: 0,
...
<p><b>The traps.</b> Option C, 2.0 m, is the simple average of the positions — the answer you get by ignoring the masses entirely. Option D, 3.5 m, comes from using the ratio 3:1 in the wrong direction. Option E, 4.0 m, is the position of the heavier mass itself.</p>
...

{
  ...
  opts: ["20 m s⁻²", "2.0 m s⁻²", "50 m s⁻²", "100 m s⁻²", "5.0 m s⁻²"],
  ans: 0,
...
},
{
  ...
  opts: ["310 rad s⁻¹", "50 rad s⁻¹", "3000 rad s⁻¹", "18 600 rad s⁻¹", "100 rad s⁻¹"],
  ans: 0,
...
},
{
  ...
  opts: ["10 m s⁻¹", "14 m s⁻¹", "20 m s⁻¹", "5.0 m s⁻¹", "100 m s⁻¹"],
  ans: 0,
...
<p><b>The traps.</b> Option B, 14 m s⁻¹, is <code>√(μrg)</code> with <code>r = 20</code> but <code>μ = 1.0</code> — or, more likely, the answer you get from forgetting the square root and computing <code>√(0.5 × 20 × 10 × 2)</code>. Option D, 5.0 m s⁻¹, is <code>μrg/2</code>. Option E, 100 m s⁻¹, is <code>v²</code> reported as <code>v</code>.</p>
...
},
{
  ...
  opts: ["4.0 m s⁻¹", "16 m s⁻¹", "2.0 m s⁻¹", "8.0 m s⁻¹", "1.6 m s⁻¹"],
  ans: 0,
...
<p><b>The traps.</b> Option B, 16 m s⁻¹, is <code>gr</code> without the square root. Option C, 2.0 m s⁻¹, is <code>gr/8</code>. Option E, 1.6 m s⁻¹, is the radius itself.</p>
...
<p><b>The traps.</b> Option B, 2.0, is the linear guess — period proportional to radius. Option C, 4.0, is <code>r²</code>, which is the dependence of <code>g</code> rather than of the period. Option D, 1.4, is <code>√2</code>, the answer you get by forgetting the <code>2πr</code> factor in the period.</p>
...
<p><b>The order-of-magnitude check.</b> Young moduli for metals are of order <code>10¹⁰</code> to <code>10¹¹ Pa</code>. Option C at <code>10¹²</code> is too stiff for any common metal, and option B at <code>10¹⁰</code> is at the soft end. Only A and D are plausible.</p>
...
},
{
  ...
  opts: ["400 N m⁻¹", "75 N m⁻¹", "200 N m⁻¹", "133 N m⁻¹", "600 N m⁻¹"],
  ans: 0,
...
<p><b>The traps.</b> Option B, 75 N m⁻¹, is the series result. Option D, 133 N m⁻¹, is the arithmetic mean. Option E, 600 N m⁻¹, is the product, which has no physical meaning here.</p>`,
...
},
{
  ...
  opts: ["1.0 J", "2.0 J", "20 J", "0.50 J", "10 J"],
  ans: 0,
...
},
{
  ...
  opts: ["6.0 mm", "0.60 mm", "60 mm", "2.4 mm", "12 mm"],
  ans: 0,
...
<p><b>The traps.</b> Option B, 0.60 mm, is a factor of ten too small — a powers-of-ten slip, which is the most likely error with an exponent as small as <code>10⁻⁵</code>. Option C, 60 mm, is a factor of ten too large. Option D, 2.4 mm, is the expansion for a 10 K rise.</p>
...
},
{
  ...
  opts: ["0.010", "0.020", "0.99", "1.01", "0.0099"],
  ans: 0,
...
<p><b>Answer: A, 0.010 — which is 1%.</b></p>
...
<p><b>The traps.</b> Option B, 0.020, is the extension in metres — a length reported where a ratio is wanted. Option C, 0.99, and option D, 1.01, are the ratios <code>L₀/L</code> and <code>L/L₀</code> rather than the fractional <i>change</i>. Option E is the final-length error described above.</p>
...

{
  ...
  opts: ["340 m s⁻¹", "34 m s⁻¹", "3400 m s⁻¹", "170 m s⁻¹", "680 m s⁻¹"],
  ans: 0,
...
<p><b>The traps.</b> Option B, 34 m s⁻¹, and option C, 3400 m s⁻¹, are both powers-of-ten errors in opposite directions. Option D, 170 m s⁻¹, is <code>fλ/2</code>. Option E, 680 m s⁻¹, is <code>f × λ × 2</code>.</p>
...
},
{
  ...
  opts: ["1.2 m", "0.60 m", "0.30 m", "2.4 m", "1.8 m"],
  ans: 0,
...
},
{
  ...
  opts: ["40 m s⁻¹", "20 m s⁻¹", "1000 m s⁻¹", "0.025 m s⁻¹", "200 m s⁻¹"],
  ans: 0,
...
},
{
  ...
  opts: ["20 m s⁻¹", "40 m s⁻¹", "2.0 m s⁻¹", "200 m s⁻¹", "0.50 m s⁻¹"],
  ans: 0,
...
<p><b>The traps.</b> Option C, 2.0 m s⁻¹, is <code>Aω/10</code>, a powers-of-ten slip. Option D, 200 m s⁻¹, is <code>ω</code> without multiplying by the amplitude.</p>`,
...
},
{
  ...
  opts: ["600 Hz", "400 Hz", "300 Hz", "800 Hz", "100 Hz"],
  ans: 0,
...
<p><b>The traps.</b> Option B, 30°, is the angle of incidence unchanged — the error of forgetting to apply Snell's law at all. Option D, 45°, and option E, 48°, are larger than the incident angle and therefore in the wrong direction. Option C, 15°, is a plausible-looking but incorrect division.</p>
...
},
{
  ...
  opts: ["1.0 mm", "0.50 mm", "2.0 mm", "0.25 mm", "4.0 mm"],
  ans: 0,
...
<p><b>The traps.</b> Option B, 0.50 mm, is <code>λD/2s</code> — treating <code>w</code> as the distance from the centre to the first fringe rather than the spacing between adjacent fringes. Option C, 2.0 mm, is exactly double, from inverting the slit separation.</p>
...
<p><b>The traps.</b> Option C, 7.0°, is roughly half the first-order angle, from a slip in the ratio. Option D, 45°, would require <code>sin θ = 0.707</code>, which corresponds to <code>d/λ ≈ 1.41</code>.</p>
...
<p><b>The traps.</b> Option B, 0.67, is <code>c_s/c</code> — the ratio inverted. Option C, 2.0, is a plausible-looking but incorrect value. Option D, 1.0, would mean the light is travelling at <code>c</code>, which contradicts the question. Option E, 3.0, is the numerator alone.</p>
